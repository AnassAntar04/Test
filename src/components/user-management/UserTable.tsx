...
import { PROFILE_TYPES, GEOGRAPHICAL_ZONES, getPermissionsByProfile } from "@/constants/user-management";
...
export const UserTable = ({ profiles, onEditUser, onToggleStatus, onDeleteUser }: UserTableProps) => {
              ...
              <TableRow key={profile.id}>
                ...
                <TableCell>
                  <Switch
                    ...
                    onCheckedChange={() => onToggleStatus(profile.id, profile.is_active)}
                  />
                </TableCell>
                 <TableCell>
                   <TooltipProvider>
                             ...
                             <AlertDialogContent>
                               <AlertDialogHeader>
                                 ...
                                 <AlertDialogDescription>
                                   Êtes-vous sûr de vouloir supprimer {profile.first_name} {profile.last_name} ? 
                                   Cette action est irréversible et supprimera définitivement l'utilisateur et tous ses rôles.
                                 </AlertDialogDescription>
                               </AlertDialogHeader>
                               <AlertDialogFooter>
